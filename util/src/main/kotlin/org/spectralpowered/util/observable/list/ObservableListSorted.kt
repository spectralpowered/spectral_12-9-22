...
/**
 * Created by Kyle Escobar on 5/23/16.
 */
class ObservableListSorted<E>(val source: ObservableList<E>, val sorter: (E, E) -> Boolean) : ObservableList<E>,
    Disposable {
...
@Deprecated("This has been renamed to 'sorting' because it sorts on the fly.", ReplaceWith("sorting(sorter)", "org.spectralpowered.util.sorting"))
