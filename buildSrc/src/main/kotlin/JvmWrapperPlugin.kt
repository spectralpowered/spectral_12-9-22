...
class JvmWrapperPlugin : Plugin<Project> {
    ...
    override fun apply(project: Project) {
        val cfg = project.extensions.create(extensionName, JvmWrapperPluginExtension::class.java)
        project.tasks.getByName(wrapperTaskName) {
            val task = this as Wrapper
...
open class JvmWrapperPluginExtension {
    var buildDir = "build"
    var windowsJvmUrl = "https://github.com/adoptium/temurin11-binaries/releases/download/jdk-11.0.13%2B8/OpenJDK11U-jre_x64_windows_hotspot_11.0.13_8.zip"
    var linuxJvmUrl = "https://github.com/adoptium/temurin11-binaries/releases/download/jdk-11.0.13%2B8/OpenJDK11U-jre_x64_linux_hotspot_11.0.13_8.tar.gz"
    var macJvmUrl = "https://github.com/adoptium/temurin11-binaries/releases/download/jdk-11.0.13%2B8/OpenJDK11U-jre_x64_mac_hotspot_11.0.13_8.tar.gz"
}
